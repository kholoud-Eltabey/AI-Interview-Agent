...
async function onRequestPost(context) {
  ...
  const { messages, temperature = 0.7, max_tokens = 1e3 } = body;
  if (!Array.isArray(messages) || messages.length === 0) {
    return json({ error: "messages must be a non-empty array." }, 400);
  }
  const safeTemp = Math.min(Math.max(Number(temperature) || 0.7, 0), 2);
  const safeTokens = Math.min(Math.max(Number(max_tokens) || 1e3, 1), MAX_TOKENS_CAP);
  let openAIRes;
  try {
...
function getCookie(request, name) {
  ...
  const match2 = cookies.split(";").map((c) => c.trim()).find((c) => c.startsWith(`${name}=`));
...
__name(nameFromToken, "nameFromToken");
...
async function onRequest(context) {
  ...
  if (url.pathname === LOGIN_PATH && request.method === "POST") {
    ...
    if (password === AUTH_PASS) {
      ...
      const token2 = await hmacSign(payload, SECRET);
      return new Response(null, {
        status: 302,
        headers: {
          "Location": "/",
          "Set-Cookie": [
            `${COOKIE_NAME}=${encodeURIComponent(token2)}`,
            "Path=/",
            "HttpOnly",
            "Secure",
            "SameSite=Lax",
...
// ../.wrangler/tmp/pages-VG2DVf/functionsRoutes-0.12914703463161037.mjs
var routes = [
  {
    routePath: "/api/chat",
    mountPath: "/api",
...
// C:/Users/kholo/AppData/Roaming/npm/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/kholo/AppData/Roaming/npm/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// C:/Users/kholo/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// C:/Users/kholo/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-hHEFaM/middleware-insertion-facade.js
...
// C:/Users/kholo/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-hHEFaM/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5091519112319595.mjs.map
